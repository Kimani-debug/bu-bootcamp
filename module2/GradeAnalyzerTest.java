...
public class GradeAnalyzerTest { 
    ...
    @Test 
    void calculateAverage_largeArray() { 
        ArrayList<Integer> scores = new ArrayList<>(Arrays.asList(60, 40, 90, 95, 45, 60, 75, 55, 20, 70)); ;
        assertEquals(61, GradeAnalyzer.calculateAverage(scores)); 
    }
}